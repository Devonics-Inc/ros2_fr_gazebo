...
def generate_launch_description():
    ...
    moveit_config = (
        MoveItConfigsBuilder("fairino30_v6_robot", package_name="fairino30_v6_moveit2_config")
        .robot_description(file_path="config/fairino30_v6_robot.urdf.xacro")
        .robot_description_semantic(file_path="config/fairino30_v6_robot.srdf")
